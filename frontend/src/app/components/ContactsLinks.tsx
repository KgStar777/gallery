...
export function ContactsLinks(props: IContactsLinksProps) {
    ...
    <>
        ...
        <a href={contactsMap.get("facebook")} target="_blank" title="facebook">
        ...
        {/* {props.priorityLanguage !== "ru" && ( */}
        <a href={contactsMap.get("instagram")} target="_blank" title="instagram">
            <svg
        ...
        <a href={contactsMap.get("watsapp")} target="_blank" title="watsapp">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50"
                className="w-4 h-5 text-teal-500 hover:text-teal-600"
            >
